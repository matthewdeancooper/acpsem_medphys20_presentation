...
\institute[USyd]{\inst{1} The University of Sydney (USyd). School of Physics.
	...
	\textbf{Docs:} \href{https://docs.pymedphys.com/background/autocontouring.html}{docs.pymedphys/com/background/autocontouring}
	\vspace{7mm}
...
% ---------------------------- FRAME ---------------------------------
%%
\begin{frame}{Method: All happy \underline{models} are alike...}
\begin{figure}
...
% ---------------------------- FRAME ---------------------------------
%%
\begin{frame}{Method: Clinical implementation}
\begin{figure}
...
\begin{frame}{Appendix: Surface dice similarity coefficient (sDSC)}
  \begin{equation}
